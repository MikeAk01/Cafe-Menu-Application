...
class AdminOrderListAdapter : RecyclerView.Adapter<AdminOrderListAdapter.MyViewHolder> {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.customer_name.setText("${order.customerID!!.lastName!!}  ${order.customerID!!.firstName!!}")
        holder.order_Price.setText(order.orderPrice.toString())
        holder.order_Status.setText(order.orderStatus)
        holder.order_DateTime.setText(order.orderPrice!!.amount.toString())
        ...
        holder.cardView.setOnClickListener {
            ...
            send.putExtra("customerLastName", orderList.get(holder.adapterPosition).customerID!!.lastName)
            send.putExtra("customerFirstName", orderList.get(holder.adapterPosition).customerID!!.firstName)
            send.putExtra("orderPrice", orderList.get(holder.adapterPosition).orderPrice!!.amount)
    ...
    class MyViewHolder: RecyclerView.ViewHolder {
        ...
        constructor(itemView: View) : super(itemView){
            customer_name = itemView.findViewById(R.id.admin_orderCustomerName)
            order_Price = itemView.findViewById(R.id.admin_orderOrderPrice)
